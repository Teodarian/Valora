...
- Fullstendig redesign av BottByrå-nettsiden til **Bit-Minimalism** (Google Stitch DESIGN.md)
- Nytt designsystem: mørk bakgrunn #131313, Space Mono + Inter, oransje #ff5c00, pixel borders, scanline-overlay
- **index.html**: ny hero med ticker-tape, prisseksjon lagt til, bot-kort med terminal-header
- **booking-frisør/restaurant/treningssenter.html**: alle redesignet til samme stil
- **Språkendring**: alle solo-referanser til "Kaushik Rompichala" fjernet — erstattet med vi/oss og "Kaushik & Teo"
- **Git**: submodule `botbyra-portfolio` fjernet fra `Valora`-repo, filer merget inn som vanlig mappe
...
3. **[BottByrå — Medium]** Sett opp Cal.com booking-lenker
4. **[BottByrå — Medium]** Test alle 3 botts på mobil (10 spørsmål hver)
5. **[Solvr — Lav]** Oppdater alle BotByrå → BottByrå i Notion-titler
